...
namespace SpaceMarbles.V5
{
    public class Menu :MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (maxSpheres.GetComponent<Renderer>().enabled == true)
            { // When options is displayed
                if (mSpheres == mSpheresMax)
                {
                    maxSpheresPlus.gameObject.SetActive(false);
                }
                else
                    maxSpheresPlus.gameObject.SetActive(true);
                ...
                if (mSpheres == mSpheresMin)
                {
                    ...
                    maxSpheresMinus.gameObject.SetActive(true);
                ...
                if (mSpeed == mSpeedMax)
                {
                    ...
                    moveSpeedPlus.gameObject.SetActive(true);
                ...
                if (mSpeed == mSpeedMin)
                {
                    ...
                    moveSpeedMinus.gameObject.SetActive(true);
            }
